...
# print(f'R2 (k2): A={NOMINAL_A_R2:.3e}  b={NOMINAL_B_R2:+.2f}  Ea={NOMINAL_EA_R2_cal:.0f} cal/mol')
...
CHECKPOINT_PATH = 'ckpt_1192k_train_final4.pt'
RESULT_PATH     = 'result_1192k_train_final4.pt'
