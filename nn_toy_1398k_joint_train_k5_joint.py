...
T_MAX_TARGET_H2O = 1e-4   # 0.1 ms

# ── NN / training hyper-parameters ───────────────────────────────────────────

HIDDEN_DIM     = 32            # bumped from 16 -- 6 inputs / 8 outputs now (was 4/7)
lr_init        = 0.03
TRAIN_FRAC     = 0.80
VAL_FRAC       = 0.10
EPOCHS         = 5000
...
CHECKPOINT_PATH = 'ckpt_1398k_joint_k5_joint_dopt_5oh.pt'
RESULT_PATH     = 'result_1398k_joint_k5_joint_dopt_5oh.pt'
...
print(f'\nOH target probes (window {T_MIN_TARGET_OH*1e6:.1f} µs .. {T_MAX_TARGET_OH*1e3:.4f} ms, TRUE joint D-optimal, k1/k2/k5):')
...
print(f'\nH2O target probes (window {T_MIN_TARGET_H2O*1e6:.1f} µs .. {T_MAX_TARGET_H2O*1e3:.4f} ms, TRUE joint D-optimal, k1/k2/k5):')
...
print(f'\n{"="*72}')
print('  1398 K Joint (OH + H2O), 3 active params (k1,k2,k5, TRUE JOINT D-OPT)  |  Zhang Table 1')
print(f'{"="*72}')
