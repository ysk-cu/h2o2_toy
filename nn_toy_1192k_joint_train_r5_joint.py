...
# coding: utf-8
#
# nn_toy_1192k_joint_train_k5_joint.py
# Joint OH + H2O surrogate (single NN)
# 1192 K, active reactions k1/k2/k5
...
CHECKPOINT_PATH = 'ckpt_1192k_joint_r5_joint_dopt.pt'
RESULT_PATH     = 'result_1192k_joint_r5_joint_dopt.pt'
...
print(f'\nTraining (1192 K joint OH+H2O+k5, {N_OH_TARGETS}-pt OH / {N_H2O_TARGETS}-pt H2O, '
...
print(f'\n{"="*72}')
print('  1192 K Joint (OH + H2O), 3 active params (k1,k2,k5, TRUE JOINT D-OPT)  |  Zhang Table 1')
print(f'{"="*72}')
