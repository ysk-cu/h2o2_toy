...
# 1398 K, active reactions k1/k2/k5
...
HIDDEN_DIM     = 16            # 6-output great-fit baseline (bump to 32 if desired)
lr_init        = 0.03
TRAIN_FRAC     = 0.80
VAL_FRAC       = 0.10
EPOCHS         = 5000
...
CHECKPOINT_PATH = 'ckpt_1398k_joint_r5_joint_dopt.pt'
RESULT_PATH     = 'result_1398k_joint_r5_joint_dopt.pt'
