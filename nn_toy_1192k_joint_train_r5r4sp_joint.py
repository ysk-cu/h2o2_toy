...
T_MAX_TARGET_H2O = 3.5e-4 # 0.35 ms  (H2O carries info only in the rise: ||S_H2O||
                          # peaks ~0.09 ms and ->0 by ~0.4 ms; capping here keeps the
                          # 3 sparse targets on informative time, the "besides dt_min" lever)

# ── NN / training hyper-parameters ───────────────────────────────────────────

HIDDEN_DIM     = 32            # Case 1: 32 nodes
lr_init        = 0.03
TRAIN_FRAC     = 0.80
VAL_FRAC       = 0.10
EPOCHS         = 5000
...
CHECKPOINT_PATH = 'ckpt_1192k_joint_r5r4sp_joint_dopt.pt'
RESULT_PATH     = 'result_1192k_joint_r5r4sp_joint_dopt_32.pt'
...
def select_targets_joint(t_oh, S_oh_mat, t_h2o, S_h2o_mat, n_oh, n_h2o, oh_min_ppm=30,
                        ...
                        dt_min_oh=5e-6, dt_min_h2o=5e-5):
    """
